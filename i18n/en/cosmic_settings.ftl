...
legacy-applications = X11 Window System Application Scaling
    ...
    .native-description = X11 applications that don't support scaling will be small when HiDPI displays are in use.
                          Enable for games to utilize the full monitor resolution.
